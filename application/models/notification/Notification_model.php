...
class Notification_model extends CI_Model {
	 ...
	 *
	 */
	public function save_notification($creator_id, $received_user_id, $channel_id) {
		$created_date = date ( "Y-m-d H:i:s" );
		$this->db->query( "INSERT INTO notifications
				(user_id, creator_id, channel_id, status, created_date, updated_date)
				VALUES ($received_user_id, $creator_id, $channel_id, 'unseen', '$created_date', '')" );
	 ...
	 *
	 */
	public function get_notification($creator_id, $received_user_id, $channel_id) {
		$this->db->where('creator_id', $creator_id);
		$this->db->where('user_id', $received_user_id);
		$this->db->where('channel_id', $channel_id);
