...
<body>
	...
	<div class="row">
		<div class="large-9 large-centered columns profile-container">
			<div class="row">
				<h3 class="large-4 columns">William Shaw</h3>
				<div class="large-8 columns">
					<ul class="stack-for-small secondary button-group personal-button">
						...
						<li><a data-reveal-id="attention-modal" href="#" class="button tiny success "><i class="fa fa-gift"></i>
								Attention</a></li>
						<li><a data-reveal-id="block-modal" href="#" class="button tiny alert"><i class="fa fa-ban"></i>
								Block</a></li>
					</ul>
				</div>
			</div>
			...
			<div class="row">
				<div class="large-5 columns">
					<img class="personal-profile-picture" width="280"
						src="<?php echo base_url(); ?>static/img/avatar.jpg" class="" />
				</div>
				<div class="large-7 columns">
					...
					<div class="row">
						...
						<div class="large-12 columns">
							...
							<div class="large-8 columns">
								<span class="personal-info-detail">02 August 1988</span> <span
									class="personal-info-detail">Brussesls, Belgium</span> <span
									class="personal-info-detail">newbiettn@gmail.com</span>
							</div>
						</div>
					</div>
					<!-- Personal Info -->
